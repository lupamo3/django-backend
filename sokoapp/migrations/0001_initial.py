    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='employees', to='sokoapp.country')),
            ],
        ),
        migrations.CreateModel(
            name='Artisan',
            fields=[
                ...
                ('marital_status', models.CharField(choices=[('S', 'Single'), ('M', 'Married')], default='S', max_length=2)),
                ('id_number', models.IntegerField()),
                ('working_hours', models.IntegerField()),
                ('number_of_children', models.IntegerField(default=0)),
                ('religion', models.CharField(choices=[('C', 'Christian'), ('M', 'Muslim')], default='C', max_length=2)),
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='artisans', to='sokoapp.country')),
            ],
        ),
    ]
